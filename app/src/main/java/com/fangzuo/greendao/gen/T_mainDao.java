...
public class T_mainDao extends AbstractDao<T_main, String> {
    ...
    public static class Properties {
        ...
        public final static Property FPayType = new Property(71, String.class, "FPayType", false, "FPAY_TYPE");
        public final static Property FAcPrd = new Property(72, String.class, "FAcPrd", false, "FAC_PRD");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"T_MAIN\" (" + //
                ...
                "\"FPAY_TYPE\" TEXT," + // 71: FPayType
                "\"FAC_PRD\" TEXT);"); // 72: FAcPrd
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, T_main entity) {
        ...
        if (FPayType != null) {
            stmt.bindString(72, FPayType);
        }
 
        String FAcPrd = entity.getFAcPrd();
        if (FAcPrd != null) {
            stmt.bindString(73, FAcPrd);
        }
    }
    ...
    public T_main readEntity(Cursor cursor, int offset) {
        T_main entity = new T_main( //
            ...
            cursor.isNull(offset + 71) ? null : cursor.getString(offset + 71), // FPayType
            cursor.isNull(offset + 72) ? null : cursor.getString(offset + 72) // FAcPrd
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, T_main entity, int offset) {
        ...
        entity.setFPayType(cursor.isNull(offset + 71) ? null : cursor.getString(offset + 71));
        entity.setFAcPrd(cursor.isNull(offset + 72) ? null : cursor.getString(offset + 72));
     }

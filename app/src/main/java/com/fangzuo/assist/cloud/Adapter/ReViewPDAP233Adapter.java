...
public class ReViewPDAP233Adapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    ...
    public ReViewPDAP233Adapter(Context context, List<T_Detail> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_pd_p2_33list, null);
...
//                viewHolder.date.setText("物料名:" + detail.get(i).FProductName);
        ...
        viewHolder.tvNum.setText("实检数量:" + mdNum);

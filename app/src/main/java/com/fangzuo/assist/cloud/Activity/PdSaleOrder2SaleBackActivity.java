...
import com.fangzuo.assist.cloud.databinding.ActivityPdSaleOrder2SaleBackBinding;
...
public class PdSaleOrder2SaleBackActivity extends BaseActivity {
    ActivityPdSaleOrder2SaleBackBinding binding;
    private int activity = Config.PdSaleOrder2SaleBackActivity;
    private int tag = 3;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pd_sale_order2_sale_back);
    ...
    protected void initData() {
        ...
        binding.spDepartmentStore.setAutoSelection(getString(R.string.spDepartmentStore_sr_bk_pd), "");
        binding.spDepartmentSale.setAutoSelection(getString(R.string.spDepartmentSale_sr_bk_pd), "");
        binding.spStoreman.setAutoSelection(getString(R.string.spStoreman_sr_bk_pd), "");
        binding.spSaleman.setAutoSelection(getString(R.string.spSaleman_sr_bk_pd), "");
        binding.spOrgSale.setAutoSelection(getString(R.string.spOrgSale_sr_bk_pd), Hawk.get(Info.user_org, ""));
        binding.spOrgStore.setAutoSelection(getString(R.string.spOrgStore_sr_bk_pd), Hawk.get(Info.user_org, ""));
...
//        }//--------------------------------------------------
    ...
    @OnClick({R.id.btn_add, R.id.tv_date, R.id.btn_backorder, R.id.btn_checkorder,R.id.tv_date_back})

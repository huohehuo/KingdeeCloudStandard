...
import com.fangzuo.assist.cloud.databinding.ActivityPrintHistory4P2Binding;
...
public class PrintHistory4P2Activity extends BaseActivity {

    ActivityPrintHistory4P2Binding binding;
...
//                Toast.showText(mContext, "扫描结果：" + res.getResult().getText());
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_print_history4_p2);
        zpSDK=new zpBluetoothPrinter(this);
        //摄像头初始化
        mCaptureManager = new ScanManager(PrintHistory4P2Activity.this, binding.zxingBarcodeScanner);
...
//    }
    ...
    public static void start(Context context){
        Intent intent = new Intent(context,PrintHistory4P2Activity.class);

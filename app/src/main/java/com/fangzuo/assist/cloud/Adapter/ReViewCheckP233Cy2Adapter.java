...
public class ReViewCheckP233Cy2Adapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    List<TempDetil> detail;
    private ViewHolder viewHolder;
    InnerClickListener mListener;
    List<Boolean> isCheck;

    public ReViewCheckP233Cy2Adapter(Context context, List<TempDetil> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_pd_p2_33_cy2_check_list, null);
...
//                viewHolder.date.setText("物料名:" + detail.get(i).FProductName);
        ...
        viewHolder.tvNum.setText("数量:" + MathUtil.D2saveInt(MathUtil.toD(detail.get(i).FRealQty)));
        viewHolder.tvWide.setText("宽度:" + detail.get(i).FWide);
        viewHolder.tvLenght.setText("长度:" + detail.get(i).FLenght);
//        viewHolder.tvAllNum.setText("支数:" + detail.get(i).FNum);

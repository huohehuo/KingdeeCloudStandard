...
interface ServiceRequest {
    ...
    @POST("{actionio}")
    Observable<BackDataLogin> actionIOLoginT(@Path("actionio") String io, @Body RequestBody params);

    @Headers({"Content-Type: application/json","Accept: application/json"})//需要添加头
    @POST("{actionio}")
    Observable<BackData> actionIOT(@Path("actionio") String io, @Body RequestBody json);

    @FormUrlEncoded
    @POST("{actionio}")
    Observable<BackDataLogin> actionIOLogin(@Path("actionio") String io, @FieldMap Map<String, Object> params);
    ...
    @FormUrlEncoded
    @POST("{actionio}")
    Observable<CommonResponse> actionIO2(@Path("actionio") String io, @FieldMap Map<String, String> params);

...
import com.fangzuo.assist.cloud.databinding.ActivityDb2FdinBinding;
...
public class Db2FDinActivity extends BaseActivity {
    ActivityDb2FdinBinding binding;
    private int activity = Config.Db2FDinActivity;
    private int tag = 7;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_db2_fdin);

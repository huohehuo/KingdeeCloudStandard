...
public class T_Detail {
    ...
    public T_Detail(String FIndex, String FBarcode, String IMIE, String FBillerID, long FOrderId, String FAccountID, int activity, String FEntryID, String FID,
            ...
            long FBoxCodeOrder, int FIsInBox, String FStr1, String FStr2, String FStr3, String FStr4, String FStr5, String FPayType, String FAcPrd) {
        this.FIndex = FIndex;
    ...
    public void setCfBaseData(Product product,Storage storage,Org org,Org huozhu,int coff,String cflenght,String cfwide,String cfthick,String qty,String lenghtany){
        if (null==product)return;
        this.FCfQty = qty;
        this.FCfLenghtAny = lenghtany;
        this.FCfLenght = MathUtil.toInt(cflenght);
        this.FCfThick = cfthick;
        this.FCfWide = cfwide;
        this.FCfM2 = (MathUtil.toD(cflenght)*MathUtil.toD(cfwide)*MathUtil.toD(qty)/1000000)+"";
        this.FCountNumber = coff;
        this.FCfProductID = product.FMaterialid;
        this.FCfProductNumber = product.FNumber;
        this.FCfUnitID = product.FProduceUnitID;
        this.FCfStorageID= storage==null?"":storage.FItemID;
        this.FCfWaveHouseID= "0";
        this.FCfStoreOrgID= org==null?"":org.FOrgID;
        this.FCfHuozhuID= huozhu==null?"":huozhu.FOrgID;
    }
...
//设置物料基础信息
    public void setProduct(Product product){
        ...
        this.FCfUnitID= product.FProduceUnitID;
        this.FItemID= product.FMaterialid;

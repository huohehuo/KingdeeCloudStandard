...
public class FragmentPris4P2Detail101 extends BaseFragment {
...
//                btnBackorder.setClickable(true);
                    ...
                    delete.setNegativeButton("反馈信息", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            DataService.pushBackJson(mContext, FragmentPris4P2Detail101.this.getClass().getSimpleName(), Hawk.get(Config.Company,""));
                        }
                    });
                    delete.create().show();
                }
...
//                            activityPager.finish();
    ...
    public FragmentPris4P2Detail101() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pris_p2_detail101, container, false);
...
//        }
        ...
        String pdata = product.FMaterialid + "|" + unit.FMeasureUnitID + "|" + volume + "|" + spActualmodel.getDataNumber() + "|" + spAuxsign.getDataNumber() + "|" + ""
                ...
                + "|" + "" + "|" + "" + "|" + "1"+"|"+adapter.getWideString()+"|"+"0"+"|"+edCeng.getText().toString()+"|"+edBatchRermark.getText().toString();
...
//        }
    ...
    @OnClick({R.id.tv_print, R.id.search, R.id.btn_add, R.id.btn_finishorder, R.id.btn_backorder, R.id.btn_checkorder, R.id.btn_add_wide})

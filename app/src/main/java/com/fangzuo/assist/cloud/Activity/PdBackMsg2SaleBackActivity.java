...
import com.fangzuo.assist.cloud.databinding.ActivityPdBackMsg2SaleBackBinding;
...
public class PdBackMsg2SaleBackActivity extends BaseActivity {
    ActivityPdBackMsg2SaleBackBinding binding;
    private int activity = Config.PdBackMsg2SaleBackActivity;
    private int tag = 6;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pd_back_msg2_sale_back);
    ...
    protected void initData() {
        ...
        binding.spDepartmentStore.setAutoSelection(getString(R.string.spDepartmentStore_bkmsg_sbk_pd), "");
        binding.spDepartmentSale.setAutoSelection(getString(R.string.spDepartmentSale_bkmsg_sbk_pd), "");
        binding.spStoreman.setAutoSelection(getString(R.string.spStoreman_bkmsg_sbk_pd), "");
        binding.spSaleman.setAutoSelection(getString(R.string.spSaleman_bkmsg_sbk_pd), "");
        binding.spOrgSale.setAutoSelection(getString(R.string.spOrgSale_bkmsg_sbk_pd), Hawk.get(Info.user_org, ""));
        binding.spOrgStore.setAutoSelection(getString(R.string.spOrgStore_bkmsg_sbk_pd), Hawk.get(Info.user_org, ""));

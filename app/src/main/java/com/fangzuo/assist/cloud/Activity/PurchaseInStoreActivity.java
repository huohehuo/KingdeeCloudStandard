...
import com.fangzuo.assist.cloud.databinding.ActivityPurchaseInStoreBinding;
...
public class PurchaseInStoreActivity extends BaseActivity {
    private int activity = Config.PurchaseInStoreActivity;
    ActivityPurchaseInStoreBinding binding;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_purchase_in_store);
...
//摄像头初始化
    ...
    protected void initData() {
        ...
        binding.spDepartmentBuy.setAutoSelection(getString(R.string.spDepartmentbuy_pis), "");
        binding.spDepartmentGet.setAutoSelection(getString(R.string.spDepartmentget_pis), "");
        binding.spBuyer.setAutoSelection(getString(R.string.spBuyer_pis), "");
...
//        binding.spSaleman.setAutoSelection(getString(R.string.spSaleMan_pis), "");
        binding.spOrgBuy.setAutoSelection(getString(R.string.spOrgbuy_pis), Hawk.get(Info.user_org,""));
        binding.spOrgGet.setAutoSelection(getString(R.string.spOrgget_pis), Hawk.get(Info.user_org,""));
        binding.spOrgBuy.setEnable(false);
...
//        DataModel.getProductForScan(code,org);
    ...
    private void Addorder() {
        try {
            ...
            main.setData(Info.getType(activity),binding.spOrgGet.getDataNumber(),binding.spOrgBuy.getDataNumber());
    ...
    public void finishOrder() {
        ...
        ab.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                share.setOrderCode(PurchaseInStoreActivity.this,ordercode);
            }
        });

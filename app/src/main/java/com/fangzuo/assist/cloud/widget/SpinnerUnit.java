...
//                    Log.e("unitId", unitId + "");
    ...
    public void setAuto(final Context context,String autoStr, final String type) {
        unitId = "";
        unitName = "";
        unitNumber = "";
...
//        }
    ...
    private void dealAuto2(List<Unit> listData,final String type,boolean check){
        list.clear();
        if (check){
            for (int i = 0; i < listData.size(); i++) {

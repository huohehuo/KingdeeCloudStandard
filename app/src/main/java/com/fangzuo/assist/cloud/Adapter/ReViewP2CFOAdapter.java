...
public class ReViewP2CFOAdapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    ...
    public ReViewP2CFOAdapter(Context context, List<T_Detail> detail, List<Boolean> isCheck) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_review_p2cfo_list, null);
...
//        viewHolder.tvBarCode.setText("条码:" + detail.get(i).FBarcode);
        ...
        viewHolder.tvNum.setText("数量:   " + detail.get(i).FRealQty);

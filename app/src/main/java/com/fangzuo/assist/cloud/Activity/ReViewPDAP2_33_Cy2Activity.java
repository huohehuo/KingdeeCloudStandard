...
import com.fangzuo.assist.cloud.Adapter.ReViewPDAP233Cy2Adapter;
...
import com.fangzuo.assist.cloud.databinding.ActivityReViewPdap233Cy2activityBinding;
...
public class ReViewPDAP2_33_Cy2Activity extends BaseActivity {
    ActivityReViewPdap233Cy2activityBinding binding;
    private int activity;
//    private String  fid;
    //    private T_main main;
    private List<T_Detail> list;
    private List<T_main> list_main;
    private ReViewPDAP233Cy2Adapter adapter;
...
//                    e.printStackTrace();
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_re_view_pdap2_33_cy2activity);
...
//                    T_mainDao.Properties.FID.eq(fid)
        ...
        Lg.e("列表数据：" ,list);
        adapter = new ReViewPDAP233Cy2Adapter(mContext, list, isCheck);
...
//            binding.tvCheckMain.setVisibility(View.GONE);
            ...
            binding.productnum.setText("实检数量:" +(MathUtil.D2saveInt(num)) + " bf");
//            binding.tvQtying.setText("码单数量:" + (MathUtil.D2saveInt(numAll)) + "");
            double pasNum = MathUtil.D2save2((num/numAll)*100);
//            binding.tvDif.setText("差异数："+(MathUtil.toD(MathUtil.D2saveInt(num))-MathUtil.toD(MathUtil.D2saveInt(numAll)))+" ; "+pasNum+"%");
        } else {
//            binding.tvCheckMain.setVisibility(View.GONE);

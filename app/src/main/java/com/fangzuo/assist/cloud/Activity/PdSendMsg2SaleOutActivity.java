...
import com.fangzuo.assist.cloud.databinding.ActivityPdSendMsg2SaleOutBinding;
...
public class PdSendMsg2SaleOutActivity extends BaseActivity {
    ActivityPdSendMsg2SaleOutBinding binding;
    private int activity = Config.PdSendMsg2SaleOutActivity;
    private int tag = 5;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pd_send_msg2_sale_out);
...
//            main.FPurchaseDeptId = binding.spDepartmentSend.getDataNumber();
    ...
    @OnClick({R.id.btn_add, R.id.tv_date, R.id.btn_backorder, R.id.btn_checkorder,R.id.search_client})

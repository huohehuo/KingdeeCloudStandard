...
import com.fangzuo.assist.cloud.databinding.ActivityReView4ReBoxBinding;
...
public class ReView4ReBoxActivity extends BaseActivity {
    ActivityReView4ReBoxBinding binding;
...
//                    e.printStackTrace();
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_re_view4_re_box);
    ...
    protected void initData() {
        ...
        //当为产品入库时，初始化打印机并连接
//        if (activity == Config.ProductInStoreActivity||activity==Config.TbInActivity||activity==Config.DgInActivity||activity==Config.WorkOrgIn4P2Activity

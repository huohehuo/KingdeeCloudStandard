...
import com.fangzuo.assist.cloud.databinding.ActivityPurchaseOrderBinding;
...
//                btnBackorder.setClickable(true);
    ...
    protected void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_purchase_order);
    ...
    protected void initData() {
        ...
        binding.spDepartmentBuy.setAutoSelection(getString(R.string.spDepartmentBuy_puo), "");
        binding.spBuyer.setAutoSelection(getString(R.string.spBuyer_puo), "");
        binding.spOrgBuy.setAutoSelection(getString(R.string.spOrgBuy_puo), Hawk.get(Info.user_org, ""));
...
//                        T_DetailDao.Properties.FBatch.eq(binding.edPihao.getText().toString())
            ...
            main.setData(Info.getType(activity), binding.spOrgBuy.getDataNumber(), binding.spOrgBuy.getDataNumber());

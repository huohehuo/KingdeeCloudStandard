...
public class TempAdapter extends RecyclerArrayAdapter<TempDetil> {
...
//        }
    ...
    class MarkHolder extends BaseViewHolder<TempDetil> {

        private TextView tvModel;
        private TextView tvM;

        public MarkHolder(ViewGroup parent) {
            super(parent, R.layout.item_temp_list);
            tvModel =   $(R.id.tv_model);
            tvM =   $(R.id.tv_m);
        }

        @Override
        public void setData(TempDetil data) {
            super.setData(data);
            tvModel.setText(data.getFLenght()+"*"+data.getFWide()+"*"+data.getFBThick());
            tvM.setText(data.getFVolume());
        }
    }
